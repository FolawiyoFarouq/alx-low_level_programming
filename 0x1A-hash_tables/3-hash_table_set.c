...
/**
 * replace_value - restores the value at a pre-existing key
 * @ht: two pointer to the hash_node_t list
 * @key: latest key to attach in the node
 * @value: value to attach in the node
 */
...
/**
 * check_key - inspect if a key live in a hash table
...
/**
 * hash_table_set - attach an element to the hash table
 * @ht: hash table to attach the element to
