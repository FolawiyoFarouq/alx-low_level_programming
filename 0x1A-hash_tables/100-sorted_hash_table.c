...
/**
 * shash_table_create - generates a hash table
 * @size: size of the array of connected list in the table
 *
...
/**
 * shash_table_set - attach an component to the hash table
 * @ht: hash table to attach the component to
 * @key: key of the component, will give the index in the array
 * @value: value of the component to save in the array
 *
